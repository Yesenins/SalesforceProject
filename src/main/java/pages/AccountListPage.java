...
public class AccountListPage extends BasePage {
    ...
    public static final String NAME_FIELD_XPATH = TABLE_XPATH + "//a[contains(@title, '%s')]";
    public static final String PHONE_BY_ACCOUNT_NAME_XPATH = NAME_FIELD_XPATH + "/ancestor::tbody//span[contains(@class, 'forceOutputPhone')]";
    ...
    public String getExistAccountName(String accountName) {
        return driver.findElement(By.xpath(String.format(NAME_FIELD_XPATH, accountName))).getText();
    }
    ...
    public AccountPage clickOnAccountName(String accountName) {
        driver.findElement(By.xpath(String.format(NAME_FIELD_XPATH, accountName))).click();
