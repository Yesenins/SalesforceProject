...
public class ContactsPage extends BasePage {
    ...
    public static final String CONTACT_OWNER_XPATH = DATA_BY_FIELD_NAME_XPATH + "//*[text() = 'ser sas']";
    ...
    public String getContactOwnerInContacts(String label) {
        return driver.findElement(By.xpath(String.format(CONTACT_OWNER_XPATH, label))).getText();
    }
